...
public class Main {
    public static void main(String[] args) {
        ...
        question1.setQuestion("The statement \"This " +
                "is a string\".indexOf(\" \"); will return:\n" + "(Note: it is looking for the space character");
        ...
        question1.addOption(option1_1, option1_1, option1_1, option1_1, option1_1);
        ...
        question7.setQuestion("What be printed if you try to compile and run the following code?\n" +
                ...
                "\n} + \n}");
        Option option7_1 = new Option("Exception in thread \"main\" java.lang.ArrayIndexOutOfBoundException", 1);
        ...
        question9.setQuestion("");
        Option option9_1 = new Option("", 1);
        Option option9_2 = new Option("", 1);
        Option option9_3 = new Option("", 1);
        Option option9_4 = new Option("]", 1);
        ...
        int[] answers = PrintUtils.getAnswers(4);
        System.out.println();
    }
    }
